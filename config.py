...
STORIES = [
    {
        "id": "HL_GALEREYA",
        "title": "проЯв — усе про сервіс",   # highlight name (шапка)
        "frames": [
            {"type": "cover"},
            ...
            {"type": "feature", "kick": "АНАЛІТИКА",
             ...
             "body": "Бачиш, що клієнт відкрив галерею, які фото дивився й що завантажив. Жодних здогадок."},
            ...
            {"type": "feature", "kick": "МОВИ",
             "head": "*Мультимовність*",
             "body": "Інтерфейс і галерея — українською та англійською. Іноземний клієнт усе зрозуміє."},
            {"type": "feature", "kick": "БРЕНД",
             "head": "Твій *бренд*, не Google",
             "body": "Твоє ім'я, кольори й власний домен із SSL. На платних тарифах проЯв ніде не згадується — біле лейблування.",
             "photo": "photo-photographer.jpg"},
            {"type": "feature", "kick": "БРОНЮВАННЯ",
             "head": "*Бронювання* зйомок",
             "body": "Клієнт сам обирає вільний слот і одразу оплачує. Синхронізація з Google Calendar."},
            {"type": "feature", "kick": "ОПЛАТА",
             "head": "Гроші — одразу *тобі*",
             "body": "Оплата напряму на твою картку: Monobank, WayForPay, банка чи реквізити. Платформа не торкається грошей."},
            {"type": "feature", "kick": "БОНУС",
             "head": "*10%* за друга",
             "body": "Реферальна програма: 10% кредитом з кожної оплати колеги, якого ти запросила."},
            {"type": "cta"},
        ],
    },
]
